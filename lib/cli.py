...
def create_parser():
    ...
    parser.add_argument('--pool', '-p', metavar='POOL', default='gem', choices=pool_names,
                        help='pooling options: ' +
                            ' | '.join(pool_names) +
                            ' (default: gem)')
    parser.add_argument('--whitening', '-w', default=0, type=int, metavar='DIM',
    ...
    parser.add_argument('--mode', '-m', metavar='MODE', default='sym',
                        choices=mode_names,
    ...
    parser.add_argument('--teacher-image-size', default=1024, type=int, metavar='N',
                        help='maximum size of longer image side used for training (default: 1024)')
    parser.add_argument('--neg-num', '-nn', default=5, type=int, metavar='N',
                        help='number of negative image per train/val tuple (default: 5)')
    parser.add_argument('--pos-num', '-pn', default=1, type=int, metavar='N',
    ...
    parser.add_argument('--optimizer', '-o', metavar='OPTIMIZER', default='adamW',
                        ...
                        help='optimizer options: ' +
                            ...
                            ' (default: adamW)')
    parser.add_argument('--scheduler', metavar='SCHEDULER', choices=scheduler_names,
